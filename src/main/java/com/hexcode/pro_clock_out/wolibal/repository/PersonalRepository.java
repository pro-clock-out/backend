...
public interface PersonalRepository extends JpaRepository<Personal, Long> {
    ...
    @Query("SELECT w FROM Personal w WHERE w.wolibal.member = :member ORDER BY w.wolibal.date DESC")
    List<Personal> findRecent10(@Param("member") Member member, Pageable pageable);
}
