...
public class WolibalService {
    ...
    public FindTotalWolibalResponse findTotalWolibal(Long memberId, String option) {
        ...
        WolibalScoreRankAvgDto totalDto = createScoreRankAvgDto(wolibal.getTotal(), "total");
    ...
    public FindLabelsWolibalResponse findLabelsWolibal(Long memberId, String option) {
        Member member = memberService.findMemberById(memberId);
        Wolibal wolibal = findWolibalByMember(member);
        WolibalScoreRankAvgDto workDto = createScoreRankAvgDto(wolibal.getWork(), "work");
        WolibalScoreRankAvgDto restDto = createScoreRankAvgDto(wolibal.getRest(), "rest");
        WolibalScoreRankAvgDto sleepDto = createScoreRankAvgDto(wolibal.getSleep(), "sleep");
        WolibalScoreRankAvgDto personalDto = createScoreRankAvgDto(wolibal.getPersonal(), "personal");
        WolibalScoreRankAvgDto healthDto = createScoreRankAvgDto(wolibal.getHealth(), "health");
